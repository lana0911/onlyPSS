...
public class ModelM : MonoBehaviour
{
	...
	//�H�U�w�]���O�p��������
	Socket serverSocket; //���A����socket
	Socket clientSocket; //�Ȥ��socket
	IPEndPoint ipEnd; //��ť��
	string recvStr; //�������r��
	string sendStr; //�ǰe���r��
	byte[] recvData = new byte[1024]; //��������ơA�������줸��
	byte[] sendData = new byte[1024]; //�ǰe����ơA�������줸��
	int recvLen; //��������ƪ���
	Thread connectThread, videoThread; //�s�u�����
	...
	void Start()
	{
		...
		// Debug.Log(txt);
		// string path = @"d:\�j��\onlyPSS\onlyPSS\\test.txt";
		// string[] createText = {""};
